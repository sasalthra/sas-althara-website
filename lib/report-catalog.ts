...
export const reportCatalog = [
 {id:'leads',label:'العملاء والمصادر والمراحل',kind:'لقطة حالية للعملاء المنشئين في الفترة أو الذين يظهرون بعلامات التصفية المسموحة',note:'تظهر جميع العملاء ضمن الصلاحية إذا طُبقت علامات التصفية المسموحة. بما أن الفلتر التاريخي الافتراضي يحدّ الفترة، قد يختفي عميل موجود في صفحة العملاء إذا كان تاريخ إنشائه خارج الفترة المحددة حالياً، أو إذا كان لا يظهر ضمن نطاق المالكية/التكليف/الميدان للمستخدم. لتظهر جميع السجلات، عيّن تاريخاً قديماً بما يكفي.',admin:false},
 ...
 {id:'properties',label:'العقارات والطلب المرتبط',kind:'كتالوج حالي + عملاء منشؤون في الفترة',note:'يُظهر الكتالوج الحالي، ثم عدد العملاء المرتبطين بكل عقار خلال الفترة، ثم العقارات أو المعرفات غير المسجلة في الكتالوج. عدد الروابط يمثل طلبات العملاء المصرح بها، وليس مبيعات أو إشغالاً. لا يوجد تاريخ حركة مخزون. العقار غير المسجل في الكتالوج يبقى مرتبطاً بملف العميل رغم ذلك.',admin:false},
 ...
 {id:'requests',label:'طلبات الموظفين',kind:'طلبات أنشئت في الفترة UTC وحالتها الحالية',note:'يشمل الإجازات والإضافي والاستئذن وتصحيح البصمة والسلفة والمصروفات والعهدة ورحلة العمل والتأشيرة. لا احتساب مالي من نص الطلب ولا سجل تاريخي للحالة.',admin:false},
